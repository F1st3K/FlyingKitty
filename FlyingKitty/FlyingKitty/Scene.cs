...
namespace FlyingKitty
{
    internal class Scene
    {
        ...
        {
            player = new Player(_level.MassPlayer * Game.G / Game.TICKRATE,
        ...
        public void LoadModel(GameWindow window)
        {
            ...
            //add player
            window.MainCanvas.Children.Add(player);
        }
        public void SetObjects()
        {
            ...
            player.SetPosition(_level.StartPlayerPosition.X, _level.StartPlayerPosition.Y);
        }
        public void Update()
        {
            //update objects
